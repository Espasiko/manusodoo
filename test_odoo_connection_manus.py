...
db = "manus_odoo_clean"  # Usando la base de datos manus_odoo_clean
username = "admin"  # Usuario administrador de Odoo
password = "admin"   # Contraseña por defecto de admin en Odoo
...
try:
    ...
    product_ids = models.execute_kw(db, uid, password,
        ...
        {'limit': 5}  # Limitar a 5 productos para la prueba
    )
